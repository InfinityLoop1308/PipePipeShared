...
import project.pipepipe.shared.job.executeClientTasksConcurrent
import project.pipepipe.shared.job.executeJobFlow
import project.pipepipe.shared.uistate.ErrorInfo
import project.pipepipe.shared.uistate.SearchSuggestion
...
class SearchViewModel() : BaseViewModel<SearchUiState>(SearchUiState()) {
    ...
    suspend fun getSuggestion(query: String) {
        ...
        if (query.isEmpty()) {
            ...
            val remoteSuggestionsResult: List<String>? = remoteSuggestionsReponse?.asJson()
